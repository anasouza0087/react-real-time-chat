...
export const Login = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center px-4">
      <div className="border-2 border-gray-700 rounded-md w-full sm:w-4/5 md:w-2/3 lg:w-1/2 h-auto min-h-[60vh] bg-gray-800 flex items-center justify-center py-8">
        <form
          onSubmit={onSubmit}
